...
|---|---|---|---|---|---|
| **mcp-k8s** | [`k8s/`](k8s/README.md) | streamable-http | 8000 | 25 (discovery / diagnosis / remediation / logs) | `v2.3.0` |
| **mcp-external** | [`external/`](external/README.md) | streamable-http | 8002 | 10 (4 OCI registry + 5 Gitea + detector_submit_rca) | `external-v0.2.1` |
...
runtime that speaks streamable-http MCP). 25 tools span:
...
- **Remediation (guarded)** — `patch_resource_limits`,
  `restart_deployment`, `restart_container`, `restart_pod`,
